		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getFunctionAccess().getVariableDeclarationAssignment_6(), "rule__Function__VariableDeclarationAssignment_6");
					put(grammarAccess.getFunctionAccess().getStatementsequenceAssignment_7(), "rule__Function__StatementsequenceAssignment_7");
					put(grammarAccess.getProcedureAccess().getParamsAssignment_2(), "rule__Procedure__ParamsAssignment_2");
					put(grammarAccess.getProcedureAccess().getVariableDeclarationAssignment_4(), "rule__Procedure__VariableDeclarationAssignment_4");
					put(grammarAccess.getProcedureAccess().getStatementsequenceAssignment_5(), "rule__Procedure__StatementsequenceAssignment_5");
