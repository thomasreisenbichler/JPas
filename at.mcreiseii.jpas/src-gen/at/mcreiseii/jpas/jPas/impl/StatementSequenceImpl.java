 ...
 * <ul>
 *   <li>{@link at.mcreiseii.jpas.jPas.impl.StatementSequenceImpl#getStatements <em>Statements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StatementSequenceImpl extends MinimalEObjectImpl.Container implements StatementSequence
{
  ...
  {
    return JPasPackage.Literals.STATEMENT_SEQUENCE;
  }
  ...
  public EList<Statement> getStatements()
  {
    if (statements == null)
    {
      statements = new EObjectContainmentEList<Statement>(Statement.class, this, JPasPackage.STATEMENT_SEQUENCE__STATEMENTS);
    }
    return statements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case JPasPackage.STATEMENT_SEQUENCE__STATEMENTS:
