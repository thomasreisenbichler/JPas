 ...
 * @generated
 */
public class JPasSwitch<T> extends Switch<T>
{
  /**
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      {
        ProcParam procParam = (ProcParam)theEObject;
        T result = caseProcParam(procParam);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      case JPasPackage.WHILE_STATEMENT:
      {
      ...
      case JPasPackage.CONDITION:
      {
        ...
        if (result == null) result = caseIfStatement(condition);
        if (result == null) result = caseWhileStatement(condition);
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Proc Param</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Proc Param</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseProcParam(ProcParam object)
  {
    return null;
  }
